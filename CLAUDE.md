...
EMAIL_FROM_ADDRESS=noreply@fishspotter.app  # REQUIRED with the key, or nothing is sent (health says
                                  # email: unconfigured, resend/forgot answer 503); must be a sender
                                  # SendGrid has authenticated. docs/runbooks/transactional-email.md
