...
**L9/L1 · /accessibility, /privacy, /terms.** The accessibility statement is stamped "v0.1 engineering draft, pending legal review" yet public, and makes absolute claims ("Every interactive control...") while admitting sub-44px gaps, with no "last tested" date. Privacy + terms state company number **12076622, contradicting the canonical 12082722**. All three render as one dense small-text column with no TOC, summary, or back-link. Evidence: `accessibility-statement.md:3,9,19,28,38-39`; `privacy-policy.md:7` + `terms-of-service.md:7,95` (wrong number); `LegalLayout.tsx:25`. Fix: correct the company number everywhere; soften absolutes to a dated known-issues list; add a plain-English summary, a TOC, and a back-link.
