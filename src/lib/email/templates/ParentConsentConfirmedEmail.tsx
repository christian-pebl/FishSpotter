 ...
 * clicked by mistake, has a way to undo it. The button comes first; the
 * repeated notice follows. The link opens the parent page for
...
export function ParentConsentConfirmedEmail({
  ...
  return (
    <EmailLayout preview={`Confirming your agreement for ${childName} on FishSpotter`}>
      ...
      <Text style={P}>
        If this was not you, or you change your mind, the parent page lets you withdraw your
        agreement
      ...
      <Text style={SMALL}>Questions: hello@pebl-cic.co.uk.</Text>
    </EmailLayout>
  );
}
