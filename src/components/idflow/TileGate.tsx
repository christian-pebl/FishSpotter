...
export function TileGate({
  ...
  /** Deprecated, no longer rendered: the "Compare side by side" button was
   *  removed (not useful). Kept on the props so existing callers don't error;
   *  passing it is a no-op. Remove the prop + caller wiring when convenient. */
